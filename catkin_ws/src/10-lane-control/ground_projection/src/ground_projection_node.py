...
class GroundProjectionNode(object):
    ...
    def __init__(self):
        ...
        #lineseglist_topic = "/"+self.robot_name+"/line_detector_node/segment_list"
        self.sub_lineseglist_ = rospy.Subscriber("~lineseglist_in",SegmentList, self.lineseglist_cb)
        #self.sub_lineseglist_ = rospy.Subscriber("/duckiebot/line_detector_node/segment_list",SegmentList, self.lineseglist_cb)
