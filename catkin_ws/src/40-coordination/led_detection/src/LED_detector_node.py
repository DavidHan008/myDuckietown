...
class LEDDetectorNode(object):
    def __init__(self):
        ...
        self.pub_detections = rospy.Publisher("/duckiebot/LED_detector_node/raw_led_detection",LEDDetectionArray,queue_size=1)
        ...
        #self.sub_cam = rospy.Subscriber("/usb_cam/image_raw/compressed",CompressedImage, self.camera_callback)
